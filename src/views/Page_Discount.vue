<template>
  <div>
    ...
    <h1 style="color:#409eff ; width: 200px ; left: 845px;top: -50px; position: relative">全部特惠书目</h1>
...
export default {
  ...
  mounted(){
    ...
    axios.get('http://localhost:8181/book/findDayDiscountBooks/'+weekday).then(function (resp){
